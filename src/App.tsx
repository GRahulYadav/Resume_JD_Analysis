                            ...
                            <div className="relative space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed max-w-md mx-auto">
                                       <h1 className="text-purple-700 font-semi-bold">Drag and drop your resume PDF here</h1>  or click to browse
                                    </p>
                                    <input
                                        type="file"
                                        accept=".pdf"
                                        ...
                                        filteredJobMatches.map((job: JobMatch, index: number) => {
                                            ...
                                            return (
                                                <div key={job.id} className={`relative overflow-hidden ${matchQuality.bgColor} rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border group`}>
                                                    ...
                                                    {expandedJob === job.id && (
                                                        <div className="border-t border-white/20 dark:border-slate-800/50 bg-gradient-to-br from-slate-50/80 to-white/80 dark:from-slate-900/80 dark:to-slate-900/80 backdrop-blur-sm p-6 lg:p-8 animate-fade-in-up">
                                                            <div className="space-y-6">
                                                                <div>
                                                                    <div className="flex items-center space-x-3 mb-4">
                                                                    ...
                                                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                                                        {Object.entries(job.scores_breakdown).map(([key, score]) => (
                                                                            <div key={key} className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-xl p-4 border border-white/20 dark:border-slate-700/50 shadow-sm">
...
function App() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-black dark:to-blue-950 transition-all duration-500">
            ...
            <footer className="relative z-10 bg-gradient-to-r from-slate-950 via-black to-slate-900 text-white py-12 lg:py-16 transition-all duration-500">
